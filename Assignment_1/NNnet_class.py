...
class NNnet:
    ...
    def __init__(self,internal_layers=8,epochs=250,units=128,batch_size=32,input_dims=17,internal_act='relu',final_act='sigmoid',optimizer=Adam,learning_rate=0.001,loss='binary_crossentropy',metrics=['accuracy'],l1_reg=0,l2_reg=0,dropout_rate=0,early_stopping_tol=0.1):
        '''Class init
    ...
    def build_model(self):
        ...
        self.internal_model.add(Dense(units=1,activation=self.final_act))
